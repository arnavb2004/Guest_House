...
const Home = () => {
    ...
    const otherLinks = [
        {id: 1, name: 'guest-house', url: 'https://www.iitrpr.ac.in/guest-house/', title: 'More detail about Guest House'},
        {id: 2, name: 'iit-ropar', url: 'https://www.iitrpr.ac.in/', title: 'Explore other things in IIT Ropar'},
    ]
    ...
    <div className='home w-2/3 grid grid-cols-4'>
        <div className="content col-span-3 p-4">
            ...
            <p className='py-2 text-l'>
                ...
                Whether guests are enjoying a peaceful walk through the gardens or focusing on academic endeavors, 
                the guest house ensures a pleasant experience filled with comfort and hospitality.
            </p>
            ...
            <p className='py-2 text-l'>
                ...
                The campus boasts sleek, contemporary buildings housing cutting-edge facilities for academics, research, and student life.
                Recreational spaces provide areas for students to relax and socialize amidst the serene surroundings. Sustainability 
                efforts are evident throughout, showcasing a commitment to environmental conservation. From academic pursuits to cultural 
                events, the campus buzzes with activity, creating a vibrant community where learning and growth thrive.
            </p>
        ...
        <div className="links col-span-1 p-4">
            ...
            <a className='my-1' href="https://www.iitrpr.ac.in/guest-house/">More details about Guest House</a>
            <hr className='border-dotted border-t-2 border-gray-400 my-1'/>
            <a className='my-1' href="https://www.iitrpr.ac.in/">Explore other things in IIT Ropar</a>
        </div>
    </div>
  )
}
